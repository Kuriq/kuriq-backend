...
public enum BadgeType {
    ...
    COURSE_20("스무 걸음", "강좌를 누적 20개 완료했어요!"),
    COURSE_30("학습 고수", "강좌를 누적 30개 완료했어요!"),
    COURSE_50("배움의 전당", "강좌를 누적 50개 완료했어요!"),

    // 로드맵 전체 이수
    ROADMAP_1("길을 완주했다", "로드맵 1개를 전체 이수 완료했어요!"),
    ROADMAP_3("세 갈래 길", "로드맵 3개를 전체 이수 완료했어요!"),
    ROADMAP_5("다섯 번의 여정", "로드맵 5개를 전체 이수 완료했어요!"),

    // 커뮤니티 활동
    FIRST_POST("드디어 한마디", "커뮤니티에 첫 게시글을 작성했어요!"),
    POPULAR_LEARNER("인기 학습자", "커뮤니티에서 좋아요 10개를 받았어요!"),
    COMMUNITY_STAR("커뮤니티 스타", "커뮤니티에서 좋아요 50개를 받았어요!"),
